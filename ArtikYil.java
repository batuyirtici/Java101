...
Artık Yıl Nedir?
    ...
    Artık yıl, Miladî takvimde 365 yerine 366 günü olan yıl. Bu fazladan gün (artık gün), normalde 28 gün olan şubat
...
public class ArtikYil
{
    public static void main(String[] args)
    {
        ...
        if (yil % 100 == 0)
        {
            if (yil % 400 == 0) {System.out.println(yil + " bir artık yıldır!");}
        ...
        else if (yil % 4 == 0) {System.out.println(yil + " bir artık yıldır!");}
